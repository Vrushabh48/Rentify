                ...
                <div className="flex flex-wrap justify-center gap-6">
                    <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
                        <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                            <img src="https://www.idfcfirstbank.com/content/dam/idfcfirstbank/images/blog/15-useful-tips-to-save-money-for-later-use-in-life-717x404.jpg" alt="Save Money" className="w-full h-48 object-cover rounded-t-lg"/>
                    ...
                    <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
                        <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                            <img src="https://media.istockphoto.com/id/1435661969/photo/close-up-of-children-holding-a-planet-at-the-beach.jpg?s=612x612&w=0&k=20&c=TuZTL8KEdqNQxS5nlsH5i1tTOKNWopj2dHWkm9yk2uo=" alt="Eco-Friendly" className="w-full h-48 object-cover rounded-t-lg"/>
                    ...
                    <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
                        <div className="bg-gray-50 p-6 rounded-lg shadow-md">
                            <img src="https://images.yourstory.com/cs/2/f02aced0d86311e98e0865c1f0fe59a2/rental-economy-1640164938054.png?mode=crop&crop=faces&ar=2%3A1&format=auto&w=1920&q=75" alt="Flexibility" className="w-full h-48 object-cover rounded-t-lg"/>
